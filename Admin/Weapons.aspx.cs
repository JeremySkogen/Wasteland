...
public partial class Admin_Weapons : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        thisCommand.CommandText = "INSERT INTO ItemWeapon VALUES ('";
        ...
        thisCommand.CommandText += TextBox6.Text + ",";
        thisCommand.CommandText += TextBox7.Text + ")";
